...
export const OSDetailsModal: React.FC<OSDetailsModalProps> = ({ os, onClose, onOpenPrint, onRefresh }) => {
  ...
  const msgOrcamento = encodeURIComponent(
    `Olá, *${os.cliente_nome}*! Tudo bem? Aqui é da *${empresa.nome_empresa}*.\n\n` +
